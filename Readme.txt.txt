...
it uses Python 3.4.3, and requires the Pybrain 3.3 package installed (it's put in the packages folder). Pybrain requires Scipy and Matplotlib packages. The easiest way to get them 
